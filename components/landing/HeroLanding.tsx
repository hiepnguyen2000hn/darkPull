...
export default function HeroLanding() {
  return (
    <section className="relative min-h-[600px] w-full overflow-hidden pt-32 pb-10">
      <div className="max-w-[1440px] mx-auto px-12 relative z-10">
        <div className="grid grid-cols-[55%_45%] gap-20 items-center">
          ...
          <div className="space-y-4">
            ...
            >
              <h1 className="font-bold flex items-center text-[30px] leading-[31px] text-[#CECFD1] mb-[2px]">
                Zero-Knowledge Proofs
              </h1>
              <h2 className="flex items-center font-normal text-[28px] leading-[34px] text-[#A1A2A5]">
            ...
            <motion.p
              ...
              className="text-[14px] leading-[1.6] max-w-[450px] pt-1 text-[#94A3B8]"
            >
          ...
          <div className="relative flex items-center justify-center">
            ...
            <motion.div
              ...
              className="absolute top-0 right-0 flex flex-col gap-1 px-3 py-2.5 rounded-lg"
              style={{
